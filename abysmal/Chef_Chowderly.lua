...
function event_trade(e)
	...
	if item_lib.check_turn_in(e.self, e.trade, {item1 = 55524}) then -- Case of Dishes
	...
	elseif item_lib.check_turn_in(e.self, e.trade, {item1 = 55525, item2 = 55526}) then -- Spicy Tuna Salad Sandwich, recipe scroll
	...
	elseif item_lib.check_turn_in(e.self, e.trade, {item1 = 55529, item2 = 55527}) then -- Recipe and Pan-seared Orange Tuna
		e.self:Emote("scarfs down the dish you created.");
	...
	elseif item_lib.check_turn_in(e.self, e.trade, {item1 = 55533, item2 = 55528}) then -- Recipe and Taelosian Tuna Kabobs
		e.self:Emote("scarfs down the dish you created.");
	...
	elseif item_lib.check_turn_in(e.self, e.trade, {item1 = 55537, item2 = 55530}) then -- Recipe and Chowderly's Delightful Tuna Cakes
	...
	elseif item_lib.check_turn_in(e.self, e.trade, {item1 = 55541, item2 = 55531}) then -- Recipe and Taelosian Tuna A La King
	...
	elseif item_lib.check_turn_in(e.self, e.trade, {item1 = 55545, item2 = 55532}) then -- Recipe and Tuna Rice Surprise
	...
	elseif item_lib.check_turn_in(e.self, e.trade, {item1 = 55549, item2 = 55534}) then -- Recipe and Spicy Tuna Sunrise Steak
