...
function event_trade(e)
    ...
    if item_lib.check_turn_in(e.self, e.trade, {item1 = 19140, item2 = 19140, item3 = 19140, item4 = 19140}) then --Branch of Sylvian Oak x4
    ...
    elseif item_lib.check_turn_in(e.self, e.trade, {item1 = 55566, item2 = 55560}) then -- Clay golem parts, Worker's Badge - Number one
    ...
    elseif item_lib.check_turn_in(e.self, e.trade, {item1 = 55556, item2 = 55564}) then -- Vial of Anti-Rusting Agent, Worker's badge - number five
    ...
    elseif item_lib.check_turn_in(e.self, e.trade, {item1 = 10503, item2 = 55565}) then -- Block of ore, Worker's badge - number six
    ...
    elseif item_lib.check_turn_in(e.self, e.trade, {item1 = 9654, item2 = 9747, item3 = 55567}) then -- Jumjum Cake, Filleted Mammoth, Workers Badge - number seven
