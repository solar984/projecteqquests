...
function event_say(e)
	...
	elseif(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) < 100) then
...
function event_trade(e)
	...
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 12341, item2 = 12342, item3 = 12343},1,text)) then
		...
		e.other:Faction(361,10); -- Ashen Order Faction ID-361
		e.other:Faction(281,1); -- Knights of Truth Faction ID-281
		e.other:Faction(309,1); -- Silent Fist Clan Faction ID-309
