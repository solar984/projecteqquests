...
function event_trade(e)
	...
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= -500 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13054})) then --doesn't require gold like dialogue says
		e.self:Say("Ok! Let me see here.. Hmmm.. Oh, excellent.. Here you go. Some of my finest work, if I must say so myself.");
		e.other:Faction(269,2); -- kithicor residence
		e.other:Faction(302,1); -- protectors of the pine
		e.other:Faction(272,1); -- jaggedpine treefolk
		e.other:Faction(324,-1); -- unkempt druids
		e.other:QuestReward(e.self,0,0,0,0,2312,500);
	elseif(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= -100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13755,gold = 13},1,text1)) then
		e.self:Say("Ok! Let me see here.. Hmmm.. Oh, excellent.. Here you go. Some of my finest work, if I must say so myself.");
		e.other:Faction(269,2); -- kithicor residence
		e.other:Faction(302,1); -- protectors of the pine
		e.other:Faction(272,1); -- jaggedpine treefolk
	...
	elseif(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 0 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13752,gold = 25},1,text2)) then
		e.self:Say("Ok! Let me see here.. Hmmm.. Oh, excellent.. Here you go. Some of my finest work, if I must say so myself.");
		e.other:Faction(269,2); -- kithicor residence
		e.other:Faction(302,1); -- protectors of the pine
		e.other:Faction(272,1); -- jaggedpine treefolk
	...
	elseif(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13766,gold = 96},1,text3)) then
		e.self:Say("Ok! Let me see here.. Hmmm.. Oh, excellent.. Here you go. Some of my finest work, if I must say so myself.");
		e.other:Faction(269,5); -- kithicor residence
		e.other:Faction(302,1); -- protectors of the pine
		e.other:Faction(272,1); -- jaggedpine treefolk
		e.other:Faction(324,-1); -- unkempt druids
