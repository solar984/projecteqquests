...
function event_trade(e)
  ...
  local qglobals = eq.get_qglobals(e.other);
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 20478})) then
		...
		e.other:QuestReward(e.self,0,0,0,0,20479);
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 20479,item2 = 20494})) then
		...
		e.other:QuestReward(e.self,0,0,0,0,20485);
	elseif (qglobals["ranger_epic15_pre"] == "10" and item_lib.check_turn_in(e.self, e.trade, {item1 = 62638, item2 = 62604})) then
		e.other:QuestReward(e.self,{itemid = 62600}); -- Item: Essence of Earth and Wind
