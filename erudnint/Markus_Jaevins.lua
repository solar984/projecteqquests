...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 18728})) then -- Tattered Note
		...
		e.other:QuestReward(e.self,0,0,0,0,13548,20); -- Old Torn Robe*
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13127})) then -- Bones (Magician)
		e.self:Say("This is fine work, young one. You keep this up and you shall be knighted before long.");
		-- Confirmed Live Factions
		e.other:Faction(254,25,0); -- gate callers
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13128})) then -- Bones (Heretic)
		e.self:Say("This is fine work, young one. You keep this up and you shall be knighted before long.");
		-- Confirmed Live Factions
		e.other:Faction(254,50,0); -- gate callers
		e.other:Faction(267,7,0); -- high guard of erudin
		e.other:Faction(266,5,0); -- high council of erudin
		e.other:Faction(265,-7,0); -- heretics
