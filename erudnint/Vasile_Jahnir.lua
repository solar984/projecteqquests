...
function event_trade(e)
	...
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13078,item2 = 13078,item3 = 7305,item4 = 7305},1,text)) then -- requires amiably, 2x summoned bread, 2x summoned daggers
		...
		e.other:Faction(254,5); --faction with Gate Callers increased
	...
	elseif(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13895})) then -- requires amiably, Rungupp
		...
		-- Confirmed Live Factions
		e.other:Faction(254,10); --faction with Gate Callers increased
		e.other:Faction(266,1); --faction with High Council of Erudin increased
		e.other:Faction(267,1); --faction with High Guards of Erudin increased
		e.other:Faction(265,-1); --faction with Heretics decreased
