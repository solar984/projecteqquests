...
function event_trade(e)
	...
	local item_lib = require("items");
		if qglobals["pre_pal"] == "1" and item_lib.check_turn_in(e.self, e.trade, {item1 = 69901}) then -- Solvent
			...
			e.other:QuestReward(e.self,{itemid = 69902}); -- scabbard
		elseif qglobals["pre_pal"] == "3" and item_lib.check_turn_in(e.self, e.trade, {item1 = 69911}) then
			...
			e.other:QuestReward(e.self,{itemid = 69912}); -- sword back but diff ID for turn-in.
