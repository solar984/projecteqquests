...
function event_trade(e)
	...
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 150 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13876})) then -- requires amiably
		...
		e.other:Faction(242,20,0); --  Deepwater Knights
	...
	elseif(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13879})) then -- requires amiably, Pearls of Odus Handin: full bag of pearls
	...
	elseif(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 350 and item_lib.check_turn_in(e.self, e.trade, {item1 = 18835,item2 = 13838,item3 = 13839,item4 = 13840},1,text1)) then -- requires amiably, Bridge Quest Handin: 3 heads + sealed list
