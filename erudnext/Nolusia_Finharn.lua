...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 13118})) then 	-- Item: Erud's Tonic
		...
		e.other:AddEXP(500);
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13123})) then	-- Item: Label of Erud's Tonic
