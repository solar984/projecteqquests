...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 18723})) then --  Tattered Note
		...
		e.other:AddEXP(100); 
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 2049})) then --  rolled up strip of cloth
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 14583,item2 = 1564})) then
		...
		e.other:Faction(265,-20,0); -- Faction: Heretics
		e.other:AddEXP(500);
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 14585})) then
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 1780,item2 = 1781,item3 = 1565})) then
