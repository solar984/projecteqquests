...
function event_enter(e)
	if(e.other:HasItem(18723)) then
		e.other:Message(MT.Yellow,"A commanding, yet kind looking Erudite turns towards you as you attempt to get your bearings. 'Do not be startled. I am Leraena Shelyrak, Guild Master for the Clerics of Quellious. Read the note in your inventory and hand it to me when you are ready to begin your training.'");
	end
end
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 18723},0)) then --  Tattered Note
		...
		e.other:Faction(298,100); --  Peace Keepers.
		e.other:Faction(266,25); --  High Council of Erudin.
		e.other:Faction(265,-25); --  Heretics.
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 2049},0)) then --  rolled up strip of cloth
		...
		-- Confirmed Live Factions
		e.other:Faction(298,2); --  Peace Keepers.
		e.other:Faction(266,1); --  High Council of Erudin.
		e.other:Faction(265,-1); --  Heretics.
	...
	elseif(e.other:GetFaction(e.self) < 5 and item_lib.check_turn_in(e.self, e.trade, {item1 = 14582},0)) then -- requires amiably
		...
		-- Confirmed Live Factions
		e.other:Faction(298,25); --  Peace Keepers.
		e.other:Faction(266,6); --  High Council of Erudin.
		e.other:Faction(265,-6); --  Heretics.
	...
	elseif(e.other:GetFaction(e.self) < 5 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13883,item2 = 13883,item3 = 13883},1,text2)) then -- requires amiably, 3x kobold shaman paw
		...
		-- Confirmed Live Factions
		e.other:Faction(298,20); -- Faction: Peace Keepers
		e.other:Faction(266,5); -- Faction: High Council of Erudin
	...
	elseif(e.other:GetFaction(e.self) < 5 and item_lib.check_turn_in(e.self, e.trade, {item1 = 14583,item2 = 1564})) then -- requires amiably
		...
		e.other:Faction(298,30); -- Faction: Peace Keepers
		e.other:Faction(266,7); -- Faction: High Council of Erudin
		e.other:Faction(265,-7); -- Faction: Heretics
	...
	elseif(e.other:GetFaction(e.self) < 5 and item_lib.check_turn_in(e.self, e.trade, {item1 = 1780,item2 = 1781,item3 = 1565},1,text)) then -- requires amiably
		...
		-- Confirmed Live Factions
		e.other:Faction(298,70); -- Faction: Peace Keepers
		e.other:Faction(266,17); -- Faction: High Council of Erudin
		e.other:Faction(265,-17); -- Faction: Heretics
