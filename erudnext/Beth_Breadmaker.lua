...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 1839}, 0)) then  -- Full Muffin Crate
		...
		e.other:Faction(289,2); -- Faction: Merchants of Erudin
		e.other:Faction(266,1); -- Faction: High Council of Erudin
		e.other:Faction(267,1); -- Faction: High Guard of Erudin
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 1838}, 0)) then  -- Bag of Bread Loaves
		...
		e.other:Faction(289,4); -- Faction: Merchants of Erudin
		e.other:Faction(266,3); -- Faction: High Council of Erudin
