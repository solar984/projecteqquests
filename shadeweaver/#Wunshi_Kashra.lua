...
function event_trade(e)
	...
	if(qglobals["shaman_epic"] == "3" and item_lib.check_turn_in(e.self, e.trade, {item1 = 57087, item2 = 57085})) then --hand in Ring of the Undead Spiritcharmer (drops from Spiritseeker Nadox in Crypt of Nadox) and Amulet of the Spiritist (drops from Netherbian Swarmfiend in Umbral Plains)
