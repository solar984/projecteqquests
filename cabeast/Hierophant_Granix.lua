...
function event_trade(e)
	...
	if(e.other:GetFaction(e.self) <= 4 and e.other:HasItem(5146)) then
		if(item_lib.check_turn_in(e.self, e.trade, {item1 = 30984}))  then
		...
		if(item_lib.check_turn_in(e.self, e.trade, {item1 = 30986})) then
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 30988, item2 = 5146})) then
