...
function event_trade(e)
	...
	if eq.is_current_expansion_secrets_of_faydwer() and item_lib.check_turn_in(e.self, e.trade, {item1 = 10092}) then -- Items: Portal Items
		set_portal(e,10092);
	elseif eq.is_current_expansion_secrets_of_faydwer() and item_lib.check_turn_in(e.self, e.trade, {item1 = 10094}) then -- Items: Portal Items
		set_portal(e,10094);
