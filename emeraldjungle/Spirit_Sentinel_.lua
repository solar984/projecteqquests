...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 1674})) then --Part of Shaman Epic 1.0
	...
	elseif(e.other:GetFaction(e.self) < 3 and item_lib.check_turn_in(e.self, e.trade, {item1 = 18456, item2 = 18457, item3 = 18458})) then --Part of Shaman Epic 1.0
	...
	elseif(e.other:GetFaction(e.self) < 3 and item_lib.check_turn_in(e.self, e.trade, {item1 = 18459})) then --Part of Shaman Epic 1.0
