function event_say(e)
	...
	elseif(e.message:findi("shipment")) then
		if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 100) then
			...
			e.other:SummonItem(18820); -- Item: Sealed Letter
...
function event_trade(e)
	...
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 12241,item2 = 12242,item3 = 12243,item4 = 12244}, 1, text)) then -- Raw Short Sword 1-4
		...
		e.other:Faction(311,20); -- Steel Warriors
		e.other:Faction(262,4); -- Guards of Qeynos
		e.other:Faction(230,-3); -- Corrupt Qeynos Guards
		e.other:Faction(330,-3); -- Freeport Militia
		e.other:Faction(281,4); -- Knights of Truth
