...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 18010})) then -- Torn Parchment
		...
		e.other:Faction(346,10); -- Faction: Commons Residents
		e.other:Faction(330,2); -- Faction: The Freeport Militia
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13987})) then -- Jeweled Skull (1st version)
		...
		e.other:Faction(346,100); -- Faction: Commons Residents
		e.other:Faction(330,25); -- Faction: The Freeport Militia
		e.other:Faction(281,25); -- Faction: Knights of Truth
		e.other:Faction(362,15); -- Faction: Priests of Marr
		e.other:QuestReward(e.self,{itemid = 13988, exp = 2000}); -- Jeweled Skull (2nd version)
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13988})) then -- Jeweled Skull (2nd version)
		...
		e.other:Faction(346,25); -- Faction: Commons Residents
		e.other:Faction(330,6); -- Faction: The Freeport Militia
		e.other:Faction(281,6); -- Faction: Knights of Truth
		e.other:Faction(362,3); -- Faction: Priests of Marr
