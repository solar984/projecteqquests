...
function event_trade(e)
	...
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 225 and item_lib.check_turn_in(e.self, e.trade, {item1 = 10400,item2 = 1903,item3 = 2299,item4 = 10131},1,text1)) then
		...
		e.other:Faction(361,50); -- Ashen Order
		e.other:Faction(281,7); -- Knights of Truth
		e.other:Faction(309,2); -- Silent Fist Clan
	...
	elseif(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 275 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13237,item2 = 13238,item3 = 10132},1,text2)) then
		...
		e.other:Faction(361,75); -- Ashen Order
		e.other:Faction(281,11); -- Knights of Truth
		e.other:Faction(309,3); -- Silent Fist Clan
