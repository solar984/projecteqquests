...
function event_trade(e)
	...
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 0 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13917,item2 = 13917,item3 = 13916,gold = 10})) then -- 2x Deathfist Shoulderpads, 1x Deathfist Slashed Belt, 10 gold
		...
		e.other:Faction(276,5,0); -- Kelethin Merchants
		e.other:Faction(246,1,0); -- Faydark's Champions
		e.other:Faction(326,1,0); -- Emerald Warriors
		e.other:Faction(5002,1,0); -- Anti-mage Faction
		e.other:QuestReward(e.self,0,0,0,0,12187,150); -- Banded Orc Vest
	elseif(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 0 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13319,item2 = 13319,item3 = 13318,item4 = 16482})) then -- 2x Crushbone Shoulderpads, 1x Crushbone Belt, 1x silk swatch
		e.self:Say("Grand doing business with you. Hold your nose. I can never get rid of the Orc stench of the vests. That is why the other merchants do not pay me much for them.");
		e.other:Faction(276,5,0); -- Kelethin Merchants
		e.other:Faction(246,1,0); -- Faydark's Champions
		e.other:Faction(326,1,0); -- Emerald Warriors
