...
function event_trade(e)
	...
	elseif(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 200 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13225})) then
		...
		e.other:Faction(220,15,0); -- Arcane Scientists
		e.other:Faction(281,3,0); -- Knights of Truth
		e.other:Faction(296,-2,0); -- Opal Dark Briar
		e.other:Faction(330,-2,0); -- Freeport Militia
