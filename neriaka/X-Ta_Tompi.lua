...
function event_trade(e)
	...
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 0 and item_lib.check_turn_in(e.self, e.trade, {item1 = 10083, item2 = 10035, item3 = 14160, item4 = 10019})) then
		e.self:Say("You have quested well - With spell and sword - Accept our thanks - And this reward.");
		e.other:Faction(239,10); 	-- The Dead
		e.other:Faction(303,1); 	-- Queen Cristanos Thex
		e.other:Faction(278,-1); -- King Naythox Thex
		e.other:Faction(275,-1); -- Keepers of the Art
		e.other:Faction(245,-1); 	-- Eldritch Collective
		e.other:Faction(1522,-20); -- Primordial Malice
	...
	elseif(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 0 and item_lib.check_turn_in(e.self, e.trade, {item1 = 10520, item2 = 10523, item3 = 10021})) then
		e.self:Say("You have quested well - With spell and sword - Accept our thanks - And this reward.");
		e.other:Faction(239,10); 	-- The Dead
		e.other:Faction(303,1); 	-- Queen Cristanos Thex
		e.other:Faction(278,-1); -- King Naythox Thex
	...
	elseif(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 0 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13150, item2 = 13152, item3 = 8331, item4 = 10024})) then
		e.self:Say("You have quested well - With spell and sword - Accept our thanks - And this reward.");
		e.other:Faction(239,10); 	-- The Dead
		e.other:Faction(303,1); 	-- Queen Cristanos Thex
		e.other:Faction(278,-1); -- King Naythox Thex
	...
	elseif(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 0 and item_lib.check_turn_in(e.self, e.trade, {item1 = 10521, item2 = 10525, item3 = 10023})) then
		e.self:Say("You have quested well - With spell and sword - Accept our thanks - And this reward.");
		e.other:Faction(239,10); 	-- The Dead
		e.other:Faction(303,1); 	-- Queen Cristanos Thex
		e.other:Faction(278,-1); -- King Naythox Thex
