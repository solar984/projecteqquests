...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 13357})) then
		...
		e.other:Faction(239,5); -- Faction: The Dead
		e.other:Faction(303,1); -- Faction: Queen Cristanos Thex
		e.other:Faction(278,-1); -- Faction: King Naythox Thex
		e.other:Faction(275,-1); -- Faction: Keepers of the Art
		e.other:Faction(245,-1); -- Faction: Eldritch Collective
		e.other:Faction(1522,-10); -- Faction: Primordial Malice
