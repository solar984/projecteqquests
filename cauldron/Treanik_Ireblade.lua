...
function event_trade(e)
	...
	if item_lib.check_turn_in(e.self, e.trade, {item1 = 60199}) then  -- Item: Note for Treanik
	...
	elseif item_lib.check_turn_in(e.self, e.trade, {item1 = 60200}) then  -- Proper Flag so not to be skipable and Item: Treanik's Tarnished Axe
