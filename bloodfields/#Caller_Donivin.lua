...
function event_trade(e)
	...
	if (qglobals["Fatestealer"] == "3" and item_lib.check_turn_in(e.self, e.trade, {item1=52349,item2=52350,item3=52351,item4=52352}) and not eq.get_entity_list():IsMobSpawnedByNpcTypeID(301033)) then 
