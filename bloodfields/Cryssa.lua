...
function event_trade(e)
	...
	if (qglobals["cleric20"] ~= nil and qglobals["cleric20"] >= "2") then
		if(item_lib.check_turn_in(e.self, e.trade, {item1 = 9956, item2 = 10399, item3 = 10235})) then -- Top Section of an Engraved Signet // Bottom Section of an Engraved Signet // Center Section of an Engraved Signet
		...
		elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 12433})) then
