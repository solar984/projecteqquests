...
function event_trade(e)
	...
	if (e.other:GetFaction(e.self) <= 1 or e.other:GetGM() and (class == "Monk" or class == "Beastlord" or class == "Druid" or e.other:GetGM())) then -- require ally and leather
		...
		if(item_lib.check_turn_in(e.self, e.trade, {item1 = 51481,item2 = 51502,item3 = 51502})) then -- leather hand rewards
		...
		elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 51480,item2 = 51501,item3 = 51501})) then -- leather wrist rewards 
		...
		elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 51479,item2 = 51500,item3 = 51500})) then -- leather arms rewards
		...
		elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 51475,item2 = 51496,item3 = 51496})) then -- leather head rewards
		...
		elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 51476,item2 = 51497,item3 = 51497,item4 = 51497})) then -- leather chest rewards 
		...
		elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 51477,item2 = 51498,item3 = 51498,item4 = 51498})) then -- leather leg rewards
		...
		elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 51478,item2 = 51499,item3 = 51499})) then -- leather feet rewards 
