...
local ORC_SPAWNIDS = { 39026, 39027, 39543, 39544, 39545, 40184, 11388 };
local GNOLL_SPAWNIDS = { 39537, 39539, 39540, 39541 }; -- leaving out some spawns because all 8 seems too much
