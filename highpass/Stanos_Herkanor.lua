...
function event_trade(e)
	...
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 0 and item_lib.check_turn_in(e.self, e.trade, {item1 = 28010,item2 = 28011})) then
		...
		e.other:Faction(332,100,0); -- Faction: Highpass Guards
		e.other:Faction(329,15,0); -- Faction: Carson McCabe
		e.other:Faction(331,15,0); -- Faction: Merchants of Highpass
		e.other:Faction(230,5,0); -- Faction: Corrupt Qeynos Guards
		e.other:Faction(330,5,0); -- Faction: The Freeport Militia
		e.other:QuestReward(e.self,{itemid = 28012, exp = 500}); -- Combined Parchment
		eq.depop();
	elseif(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 0 and item_lib.check_turn_in(e.self, e.trade, {item1 = 28013,item2 = 7506,item3 = 7505},1,text)) then
		...
		e.other:Faction(230,5,0); -- Faction: Corrupt Qeynos Guards
		e.other:Faction(330,5,0); -- Faction: The Freeport Militia
		e.other:QuestReward(e.self,{itemid = 11057, exp = 10000}); -- Ragebringer
		eq.depop();
	elseif(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 0 and item_lib.check_turn_in(e.self, e.trade, {item1 = 18961})) then
		...
		e.other:Faction(230,5,0); -- Faction: Corrupt Qeynos Guards
		e.other:Faction(330,5,0); -- Faction: The Freeport Militia
		e.other:QuestReward(e.self,{itemid = 28057, exp = 500}); -- Sealed Box
		eq.depop();
	end
