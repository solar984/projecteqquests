...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 28010,item2 = 28011})) then
		...
		e.other:AddEXP(500);
		eq.depop();
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 28013,item2 = 7506,item3 = 7505})) then
		...
		eq.depop();
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 18961})) then
