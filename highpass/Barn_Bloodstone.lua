...
function event_trade(e)
	...
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 0 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13130})) then -- Blackburrow Stout
		...
		e.other:Faction(336,20); -- Coalition of Tradefolk Underground
		e.other:Faction(63,20); -- Coalition of Tradefolk
