...
function event_trade(e)
    ...
    if qglobals["bard15"] == "5" and item_lib.check_turn_in(e.self, e.trade, {item1 = 77629}) then -- Vhalen's Necklace
        ...
        entity_list:MessageClose(e.self, true, 120, MT.Default, "You notice a distinct change in the air around you as something inside your packs grows hot and heavy.  Black tendrils sprout from your pack as the words of Hsagra echo in your mind.  Beware the orb!")
        entity_list:MessageClose(e.self, true, 120, MT.Default, "Black ooze begins to float out from " .. e.other:GetName() .. "'s body and wrap around Metala's body as she twitches and spasms violently.")
        entity_list:MessageClose(e.self, true, 120, MT.Default, "As you struggle to regain your balance and equilibrium you look on in horror as Metala's body begins to twitch and jerk.  Bones snapping and sinew stretching.  Her face seems to struggle against her bones as they contort into a horrific new visage of torment.")
