...
function event_trade(e)
	...
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13309})) then
		...
		e.other:Faction(306,-3); -- Sabertooths of Blackburrow
	...
	elseif(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 17970,item2 = 17970, item3 = 17970},1,text)) then
		...
		e.other:Faction(302,20); -- Faction: Protectors of Pine
		e.other:Faction(272,5); -- Faction: Jaggedpine Treefolk
		e.other:Faction(306,-3); -- Faction: Sabertooths of Blackburrow
	...
	elseif(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= -100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 18811})) then
		...
		e.other:Faction(306,-1); -- Sabertooths of Blackburrow
		e.other:Faction(262,1); -- Guards of Qeynos
