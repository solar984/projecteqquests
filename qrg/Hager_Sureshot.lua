...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 18709})) then
		...
		e.other:Faction(302,100); -- Protectors of Pine
		e.other:Faction(272,25); -- Jaggedpine Treefolk
		e.other:Faction(306,-15); -- Sabertooths of Blackburrow
		e.other:Faction(262,25); -- Guards of Qeynos
		e.other:QuestReward(e.self,{itemid = 13509, exp = 20}); -- Item: Mud Stained Tunic*
