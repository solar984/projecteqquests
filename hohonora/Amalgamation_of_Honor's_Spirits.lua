...
eq.zone_emote(MT.White,"The spirits of Honor's fallen Heroes begin to coalesce in front of you.");
end
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 28710,item2 = 28709,item3 = 28724,item4 = 28725})) then  -- Lock of Tangled Banshee Hair, Nightmare Hoof, Malarian Wing, Tattered Leperoth Clothing
