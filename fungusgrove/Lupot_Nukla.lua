...
function event_trade(e)
	...
	local qglobals = eq.get_qglobals(e.other);
	if(qglobals["shaman_epic"] == "9" and item_lib.check_turn_in(e.self, e.trade, {item1 = 57401})) then --hand in Necklace of Perseverance (looted from Ikaav Spiritstealer in KT)
	...
	if(qglobals["shaman_epic"] == "10" and item_lib.check_turn_in(e.self, e.trade, {item1 = 57403})) then -- hand in Piece of Moaning Timber (looted from a Darkened Chanting Woodspirit in Plane of Storms)
