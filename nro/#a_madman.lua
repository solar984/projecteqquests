...
function event_timer(e)
	if(e.timer=="start") then
		...
		eq.spawn2(34037,0,0,e.self:GetX()-15,e.self:GetY()-15,e.self:GetZ(),e.self:GetHeading()); -- NPC: a_haunt
