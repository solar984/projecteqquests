...
function event_trade(e)
	...
	if(qglobals["paladin_epic"] ~= nil and qglobals["paladin_epic"] >= "4" and item_lib.check_turn_in(e.self, e.trade, {item1 = 69945})) then
	...
	if(qglobals["paladin_epic"] ~= nil and qglobals["paladin_epic"] >= "5" and item_lib.check_turn_in(e.self, e.trade, {item1 = 69949})) then
