...
function event_trade(e)
   ...
   if (e.other:GetFaction(e.self) <= 2) then
		if (item_lib.check_turn_in(e.self, e.trade, {item1 = 64011})) then --head of the aneuk overseer
      eq.local_emote({e.self:GetX(), e.self:GetY(), e.self:GetZ()}, MT.White, 100,"The look on Vasha Firaji's face softens and a tear rolls down her cheek. 'Thank you friend. With the beast where he belongs, I can finally begin to mourn. Please take this bracelet as a token of my thanks. It was my husband's. Proteri Amari tells me there is some magic locked away inside it.");
