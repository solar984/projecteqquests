function event_trade(e)
	local item_lib = require("items");
		if (item_lib.check_turn_in(e.self, e.trade, {item1 = 64007})) then --poisoned fruit
    ...
    elseif (item_lib.check_turn_in(e.self, e.trade, {item1 = 64009,item2 = 64010})) then --serving tray / poisoned fruit
