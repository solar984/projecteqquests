...
function event_say(e)
	...
	elseif(e.message:findi("xentil"))then 
		if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 200) then -- requires high amiably faction	
...
function event_trade(e)
	...
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 200 and item_lib.check_turn_in(e.self, e.trade, {item1 = 12185})) then 		--Useless Coin requires amiably faction
