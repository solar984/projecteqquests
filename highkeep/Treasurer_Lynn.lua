...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 12261})) then
		...
		e.other:QuestReward(e.self,{copper = math.random(20), silver = math.random(15), exp = 500});
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 12266})) then
		...
		e.other:QuestReward(e.self,{itemid = 12267, exp = 500}); -- Item: Highkeep Royal Suite
	end
