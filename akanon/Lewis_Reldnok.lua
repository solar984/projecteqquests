...
function event_say(e)
	...
	if qglobals["paladin_epic"] ~= nil and qglobals["paladin_epic"] == "9" then
		if e.message:findi("hail") then
			e.self:Say("Greetings " .. e.other:GetRaceName() .. " What can a brave and noble Paladin like I help you with? Are you possibly looking for a [blessed gem]?");
