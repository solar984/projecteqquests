...
function event_trade(e)
    ...
    if item_lib.check_turn_in(e.self, e.trade, {item1 = 55557, item2 = 55561}) then -- Note to Gilipus, Worker's Badge - Number two
    ...
    elseif item_lib.check_turn_in(e.self, e.trade, {item1 = 55555, item2 = 55562}) then -- Gilipus's Reading Glasses, Worker's Badge - Number three
    ...
    elseif item_lib.check_turn_in(e.self, e.trade, {item1 = 12418, item2 = 55563}) then -- Rubbing Alcohol, Worker's badge - number four
