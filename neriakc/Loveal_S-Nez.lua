...
function event_trade(e)
	...
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 18828})) then--Testimony
		...
		e.other:Faction(239,25); --The Dead
		...
		e.other:Faction(1522,-50); --Primordial Malice
		e.other:QuestReward(e.self,0,0,5,1,2317,33750); --Cloak of the Undead Eye
	elseif(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13390})) then--Thex Mallet
		...
		e.other:Faction(275,-15); --Keepers of Art
