function event_say(e)
    if(e.message:findi("hail")) then
        e.self:Say("Hello, " .. e.other:GetCleanName() .. ". I was hired to eradicate all these pesky rodents running around the city, but there are too many of them. If you could help me by bringing back four of their whiskers I should have a few spare coins for you.");
    end
end
