...
function event_trade(e)
	...
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 0 and item_lib.check_turn_in(e.self, e.trade, {platinum = 7})) then
		e.self:Say("Take this note to the Scribe of Dal, and perhaps she will break her vow.");
		-- confirmed live factions
		e.other:Faction(236, 10);--Dark Bargainers		
