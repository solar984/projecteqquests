function event_say(e)
	...
	elseif(e.message:findi("armor")) then
		...
		e.other:SummonItem(19584); -- Item: Request Parchment
...
function event_trade(e)
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 19573})) then
		...
		e.other:Faction(303,2); --Queen Cristanos Thex
		e.other:Faction(278,-2); --King Naythox Thex
		e.other:Faction(275,-2); --Keepers of Art
		e.other:Faction(245,-2); --Eldritch Collective
