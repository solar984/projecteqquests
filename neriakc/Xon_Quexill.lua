...
function event_enter(e)
	if e.other:HasItem(18758) then
		e.other:Message(MT.Yellow,"Xon Quexill turns towards you. 'Welcome to the Lodge of the Dead. I am Xon Quexill and with my training you will learn to master the Necromantic arts. Read the note in your inventory and hand it to me when you are ready to begin your training.'");
	end
end
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 18474})) then
		...
		e.other:Faction(239,1); -- Faction: The Dead
		e.other:Faction(303,1); -- Faction: Queen Cristanos Thex
		e.other:Faction(278,-3); -- Faction: King Naythox Thex
		e.other:Faction(275,-3); -- Faction: Keepers of the Art
		e.other:Faction(245,-3); -- Faction: Eldritch Collective
		e.other:Faction(1522,-3); -- Faction: Primordial Malice
