...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 16170, item2 = 16170, item3 = 16170})) then
		...
		e.other:Faction(236,5); -- Faction: Dark Bargainers
		e.other:Faction(370,1); -- Faction: Dreadguard Inner
