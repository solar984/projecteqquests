function event_say(e)
	...
	elseif(e.message:findi("gather some item")) then
		...
		e.other:SummonItem(17244); -- Item: Old Enchanted Box
	elseif(e.message:findi("glove")) then
		...
		e.other:SummonItem(22588); -- Item: An Enchanted Gloves Pattern
	elseif(e.message:findi("bracer")) then
		...
		e.other:SummonItem(22584); -- Item: An Enchanted Bracer Pattern
	elseif(e.message:findi("trouser")) then
		...
		e.other:SummonItem(22587); -- Item: An Enchanted Trousers Pattern
	elseif(e.message:findi("slipper")) then
		...
		e.other:SummonItem(22630); -- Item: An Enchanted Slippers Pattern
	elseif(e.message:findi("sleeve")) then
		...
		e.other:SummonItem(22586); -- Item: An Enchanted Sleeves Pattern
	elseif(e.message:findi("skullcap")) then
		...
		e.other:SummonItem(22583); -- Item: An Enchanted Cap Pattern
	elseif(e.message:findi("robe")) then
		...
		e.other:SummonItem(22589); -- Item: An Enchanted Robe Pattern
	...
	elseif(e.message:findi("ready to be test")) then
		...
		e.other:SummonItem(17243); -- Item: An Ancient Book Binding
	end
end
