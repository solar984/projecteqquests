...
function event_trade(e)
	...
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 500 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13394, gold = 10},1,text)) then -- Ring of the Dead
