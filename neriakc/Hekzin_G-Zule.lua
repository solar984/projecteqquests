function event_say(e)
	...
	elseif(e.message:findi("new rogue")) then
		if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 100) then -- need higher than 0 indiff, maybe 50 but works at amiable for sure
			...
			e.other:SummonItem(17943); -- Item: Empty Bag
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 13889})) then
		...
		e.other:Faction(320,-2); -- Faction: Wolves of the North
		e.other:Faction(262, -1); -- Faction: Guards of Qeynos
		e.other:Faction(244, 10); -- Faction: Ebon Mask
