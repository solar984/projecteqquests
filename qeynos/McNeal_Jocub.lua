function event_say(e)
	...
	elseif(e.message:findi("pick up.* shipment")) then
		...
		e.other:SummonItem(18800); -- Item: A tattered note
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 13131})) then
		...
		e.other:Faction(345,30,0); -- Faction: Karana Residents
		e.other:Faction(262,7,0); -- Faction: Guards of Qeynos
		e.other:Faction(341,4,0); -- Faction: Priests of Life
		e.other:Faction(280,9,0); -- Faction: Knights of Thunder
	...
	if(moonstone > 0) then
		repeat
			...
			e.other:Faction(345,1); -- Faction: Karana Residents
			e.other:Faction(262,1); -- Faction: Guards of Qeynos
			e.other:Faction(341,1); -- Faction: Priests of Life
			e.other:Faction(280,1); -- Faction: Knights of Thunder
