function event_say(e)
	if(e.message:findi("tale")) then
		if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) < 3) then			
		...
		elseif(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) < 6) then
...
function event_trade(e)
	...
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) < 3 and item_lib.check_turn_in(e.self, e.trade, {item1 = 8919, item2 = 8951})) then
