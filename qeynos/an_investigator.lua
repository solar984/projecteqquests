...
function event_say(e)
	...
	elseif(e.message:findi("summon a guard") and e.other:HasItem(2394)) then
		e.self:Say("Guards!  Take this man away.");
		eq.unique_spawn(1314,66,0,-413,50,-24,0); -- NPC: Guard_Sylus
	elseif(e.message:findi("summon a guard") and e.other:HasItem(2369)) then
		e.self:Say("Guards!  Take this man away.");
		eq.unique_spawn(1182,64,0,-246,145,3,0); -- NPC: #Guard_Sylus
	elseif(e.message:findi("summon a guard") and (not e.other:HasItem(2369) or not e.other:HasItem(2394))) then
