...
function event_trade(e)
	...
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) <= 4 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13423})) then -- requires amiably
	...
	elseif(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) <= 4 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13424, item2 =13424, item3 = 13424,item4 = 13424},1,text)) then
		...
		-- Confirmed Live Faction
		e.other:Faction(311,20,0); -- Faction: Steel Warriors
		e.other:Faction(262,4,0); -- Faction: Guards of Qeynos
		e.other:Faction(230,-3,0); -- Faction: Corrupt Qeynos Guards
		e.other:Faction(330,-3,0); -- Faction: The Freeport Militia
		e.other:Faction(281,4,0); -- Faction: Knights of Truth
