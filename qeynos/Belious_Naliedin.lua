...
function event_trade(e)
	...
	elseif(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) <= 4 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13775, item2 = 13776, item3 = 13777, item4 = 13778})) then -- requires amiably faction
