...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 13799,item2 = 13799,item3 = 13799,item4 = 13799},1,text)) then
		...
		e.other:Faction(262,50,0); -- confirmed live factions
		e.other:Faction(219,7,0); -- Faction: Antonius Bayle
		e.other:Faction(230,-7,0); -- Faction: Corrupt Qeynos Guards
		e.other:Faction(223,-12,0); -- Faction: Circle of Unseen Hands
