function event_say(e)
	...
	elseif(e.message:findi("paladin of karana")) then
		e.self:Say("That is excellent news " .. e.other:GetCleanName() .. ". As a Knight in training of Karana I would like to offer you a series of [tests] what will test your devotion to yourself and your god.");
	...
	elseif(e.message:findi("fashioning your materials")) then
		e.self:Say("Excellent " .. e.other:GetCleanName() .. ". Please take this Rainkeepers Assembly Kit. Now for your materials you will fashion you will obviously need to know what items are used for what armor materials. Simply tell me what armor piece you [want] to create and I will present you with the recipe for that specific armor material. I can present you with the molds and recipes necessary for creating Rainkeeper [Helm], [Bracers], [Armguards], [Boots], [Greaves], [Gauntlets] and [Breastplate].");
	...
	elseif(e.message:findi("armguard")) then
		...
		e.other:SummonItem(22613); -- Item: An Enchanted Armguard Mold
	elseif(e.message:findi("boot")) then
		...
		e.other:SummonItem(22612); -- Item: An Enchanted Boot Mold
	elseif(e.message:findi("bracer")) then
		...
		e.other:SummonItem(22611); -- Item: An Enchanted Bracer Mold
	elseif(e.message:findi("breastplate")) then
		...
		e.other:SummonItem(22616); -- Item: An Enchanted Breastplate Mold
	elseif(e.message:findi("gauntlet")) then
		...
		e.other:SummonItem(22615); -- Item: An Enchanted Gauntlet Mold
	elseif(e.message:findi("greave")) then
		...
		e.other:SummonItem(22614); -- Item: An Enchanted Greaves Mold
	elseif(e.message:findi("helm")) then
		...
		e.other:SummonItem(22610); -- Item: An Enchanted Helm Mold
