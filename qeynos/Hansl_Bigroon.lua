function event_say(e)
	...
	elseif(e.message:findi("not care for that place")) then
		e.self:Say("Then you would not care to hear about my grand plan.");
	...
	elseif(e.message:findi("list of the engineers")) then	
		e.self:Say("Do not concern yourself with the list. It is of no concern to you. I do not even have it. It is tucked away safely at home.");
...
function event_enter(e)
	...
	e.other:SummonItem(18835); -- Item: A Sealed List
	eq.clear_proximity();
end
