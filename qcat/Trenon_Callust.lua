...
function event_enter(e)
	if e.other:HasItem(18852) then
		e.other:Message(MT.Yellow,"As you orient yourself amongst the filth and decay of the catacombs, a menacing figure turns to address you. 'I am Trenon Callust. Should you wish to dedicate your pathetic life to the way of Bertoxxulous and learn the ways of the Wizard, read the note in your inventory and hand it to me to begin your training.'");
	end
end
