...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 18850})) then --Blood Stained Note
		...
		e.other:QuestReward(e.self,0,0,0,0,13595,20); --Stained Purple Robe*
	end
