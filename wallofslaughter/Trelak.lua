...
function event_trade(e)
	...
	if (e.other:GetFaction(e.self) <= 1 or e.other:GetGM() and (class == "Warrior" or class == "Paladin" or class == "Shadow Knight" or class == "Bard" or class == "Cleric" or e.other:GetGM())) then -- require ally and plate
		...
		if(item_lib.check_turn_in(e.self, e.trade, {item1 = 51475,item2 = 51482,item3 = 51482})) then -- plate helm rewards
		...
		elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 51479,item2 = 51486,item3 = 51486})) then -- plate ARMS rewards 
		...
		elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 51480,item2 = 51487,item3 = 51487})) then -- plate bracer rewards
		...
		elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 51481,item2 = 51488,item3 = 51488})) then -- plate glove rewards 
		...
		elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 51476,item2 = 51483,item3 = 51483,item4 = 51483})) then -- plate chest rewards 
		...
		elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 51477,item2 = 51484,item3 = 51484,item4 = 51484})) then -- plate leg rewards 
		...
		elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 51478,item2 = 51485,item3 = 51485})) then -- plate boots rewards
