...
function event_trade(e)
	...
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 18818})) then -- Tattered Flier
		e.self:Say("It is about time you returned! Innoruuk would be proud of the red you have spread upon the land.");
		e.other:Faction(271,30); -- Dismal Rage
		e.other:Faction(281,-4); -- Knights of Truth
		e.other:Faction(296,6); -- Opal Dark Briar
