...
function event_trade(e)
	...
	local level = eq.get_level(0);
	
	if(level >= 35 and item_lib.check_turn_in(e.self, e.trade, {item1 = 17859,item2 = 10908})) then -- Red Scabbard (Old), Jagged Blade of War (Old)
		...
		e.other:QuestReward(e.self,{items = {17869,66175}}); -- Red Scabbard (New), Jagged Blade of War (New)
	end
