function event_say(e)
	if(eq.is_the_shadows_of_luclin_enabled()) then
		...
		elseif(e.message:findi("follow the path of rage")) then
			...
			e.other:Summon(19845); -- Note to Quan Nektogo
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 19934})) then -- Raenna Griff's Head
		...
		e.other:QuestReward(e.self,0,0,0,0,19923,200); --Dull Dismal Longsword
	end
