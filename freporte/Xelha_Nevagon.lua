...
function event_trade(e)
	...
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 0 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13099, item2 = 13099, item3 = 13099, item4 = 13099},1,text2)) then -- Spiderling Silk
		...
		e.other:Faction(271,10); -- Dismal Rage
		e.other:Faction(281,-1); -- Knights of Truth
		e.other:Faction(296,2); -- Opal Dark Briar
		e.other:QuestReward(e.self,math.random(9),math.random(7),0,0,12247,250); -- Xelha's Sparkler
	elseif(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 0 and item_lib.check_turn_in(e.self, e.trade, {item1 = 10307, item2 = 10307, item3 = 10307, item4 = 10307},1,text1)) then -- Fire Beetle Eye
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13073, item2 = 13073, item3 = 13073, item4 = 13073})) then -- Bone Chips -- worked at appre
		...
		-- HK confirmed live factions
		e.other:Faction(271,5); -- Dismal Rage
		e.other:Faction(281,-1); -- Knights of Truth
		e.other:Faction(296,1); -- Opal Dark Briar
		-- Confirmed Live Experience
		e.other:QuestReward(e.self,math.random(9),0,0,0,0,250);		
	elseif(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 500 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13927})) then -- Cyclops Eye
		...
		-- HK confirmed live factions
		e.other:Faction(271,25); -- Dismal Rage
		e.other:Faction(281,-3); -- Knights of Truth
		e.other:Faction(296,5); -- Opal Dark Briar
