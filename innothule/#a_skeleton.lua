function event_say(e)
	...
	elseif(e.message:findi("captain")) then
		if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 200) then -- requires mid amiably	
...
function event_trade(e)
	...
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 200 and item_lib.check_turn_in(e.self, e.trade, {item1 = 12218})) then --Ship in a bottle
