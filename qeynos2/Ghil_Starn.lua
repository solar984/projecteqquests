...
function event_trade(e)
	...
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 0 and item_lib.check_turn_in(e.self, e.trade, {item1 = 18796})) then
		...
		e.other:QuestReward(e.self,{itemid = 1049, exp = 50000}); -- Item: Brown Leather Gloves
	end
