...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 18824})) then -- Slip of Parchment
		...
		e.other:Faction(230, 25); -- Corrupt Qeynos Guards
		e.other:Faction(262, -3); -- Guards of Qeynos
		e.other:Faction(273, 3); -- Kane Bayle
		e.other:Faction(223, 2); -- Circle Of Unseen Hands
		e.other:Faction(221, 3); -- Bloodsabers
		e.other:QuestReward(e.self,{copper = math.random(16), silver = math.random(8), exp = 250});
	end
