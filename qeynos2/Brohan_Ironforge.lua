...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 18863})) then -- Sealed Letter
		...
		e.other:Faction(291,50); -- Merchants of Qeynos
		e.other:Faction(223,-10); -- Circle of Unseen Hands
		e.other:Faction(219,7); -- Antonius Bayle
		e.other:Faction(229,5); -- Coalition of Tradefolk
		e.other:Faction(262,10); -- Guards of Qeynos
		e.other:QuestReward(e.self,0,0,0,0,eq.ChooseRandom(5303,5304,5305,5313,6303,6311,6312,7300,7301,7311),1000);
	end
