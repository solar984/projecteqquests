...
function event_trade(e)
	...
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction())>= 0 and item_lib.check_turn_in(e.self, e.trade, {item1 = 18862})) then
	 ...
	 elseif(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction())>= 150 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13952})) then
		...
		e.other:Faction(280,6,0); -- Faction: Knights of Thunder
		e.other:Faction(262,10,0); -- Faction: Guards of Qeynos
		e.other:Faction(221,-5,0); -- Faction: Bloodsabers
		e.other:Faction(219,3,0); -- Faction: Antonius Bayle
		e.other:QuestReward(e.self,0,math.random(10),0,0,eq.ChooseRandom(13954,13955),1000); -- either good or bad Prime Healer Potion
	elseif(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction())>= 150 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13970})) then
