function event_say(e)
	if(eq.is_the_shadows_of_luclin_enabled()) then
		...
		elseif(e.message:findi("find him")) then
			if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) <= 5) then -- requires indifferent faction
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 27425, item2 = 27426, item3 = 27427})) then
		...
		e.other:Faction(309,10); -- Silent Fist Clan faction
		e.other:Faction(262,1); -- Guards of Qeynos faction
		e.other:Faction(361,1); -- Ashen Order faction
