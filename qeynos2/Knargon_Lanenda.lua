...
function event_trade(e)
	...
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 0 and item_lib.check_turn_in(e.self, e.trade, {item1 = 18722})) then -- Sealed Note For Knargon
		...
		e.other:QuestReward(e.self,{exp = 100});	-- confirmed Live exp
	end
