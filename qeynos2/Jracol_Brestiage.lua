...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 13903})) then -- Bent Card -- no faction requirement
		...
		e.other:Faction(329,5); -- Carson McCabe
		e.other:Faction(336,3); -- Coalition of Tradefolk Underground
		e.other:Faction(304,-1); -- Ring of Scale
		e.other:Faction(332,5); -- Highpass Guards
		e.other:Faction(331,5); -- Merchants of Highpass
		e.other:QuestReward(e.self,{itemid = 18722,exp = 100});	-- confirmed Live exp
	end
