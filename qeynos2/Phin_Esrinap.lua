...
function event_say(e)
	...
	elseif(e.message:findi("yellow headband")) then
		if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 175) then
	...
	elseif(e.message:findi("orange headband")) then
		if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 225) then
...
function event_trade(e)
	...
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= -100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 18922})) then
		...
		e.other:Faction(309,5); -- Faction: Silent Fist Clan
		e.other:Faction(262,1); -- Faction: Guards of Qeynos
		e.other:Faction(361,1); -- Faction: Ashen Order
		e.other:QuestReward(e.self,{itemid = 13006, exp = 1500}); -- Water Flask
	-- White Headband ID-10110 requires four Gnoll Pup Scalp ID-13789
	elseif(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 150 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13789,item2 = 13789, item3 = 13789,item4 = 13789},1,text1)) then -- verified xp live 9/16/2023
		...
		e.other:Faction(309,25); -- Faction: Silent Fist Clan
		e.other:Faction(262,3); -- Faction: Guards of Qeynos
		e.other:Faction(361,1); -- Faction: Ashen Order
		e.other:QuestReward(e.self,{itemid = 10110, exp = 200}); -- Item: White Headband 
	-- Yellow Headband ID-10111 requires three Putrid Rib Bone ID-13722 and the White Headband ID-10110
	elseif(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 175 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13722,item2 = 13722, item3 = 13722,item4 = 10110},1,text2)) then -- verified xp live 9/16/2023
		...
		e.other:Faction(309,50); -- Faction: Silent Fist Clan
		e.other:Faction(262,7); -- Faction: Guards of Qeynos
		e.other:Faction(361,2); -- Faction: Ashen Order
		e.other:QuestReward(e.self,{itemid = 10111, exp = 400}); -- Item: Yellow Headband
	...
	elseif(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 225 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13027,item2 = 13027, item3 = 13028,item4 = 10111},1,text3)) then -- verified xp live 9/16/2023
		...
		e.other:Faction(262,7); -- Faction: Guards of Qeynos
		e.other:Faction(361,2); -- Faction: Ashen Order
		e.other:QuestReward(e.self,{itemid = 10112, exp = 800}); -- Item: Orange Headband
	end
