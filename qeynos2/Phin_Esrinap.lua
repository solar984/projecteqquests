...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 13789,item2 = 13789, item3 = 13789,item4 = 13789}) and fac <= 5) then
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 18922})) then
