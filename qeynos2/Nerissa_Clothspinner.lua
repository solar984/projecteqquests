...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 13302})) then --Monogrammed Cloth
		...
		e.other:Faction(291, 15); -- confirmed live factions
		e.other:Faction(223, -3); -- Faction: Circle of Unseen Hands
		e.other:Faction(219, 2); -- Faction: Antonius Bayle
		e.other:Faction(229, 1); -- Faction: Coalition of Tradefolk
		e.other:Faction(262, 3); -- Faction: Guards of Qeynos
		e.other:QuestReward(e.self,{silver = math.random(10), itemid = 18862, exp = 3000}); -- Item: A tattered note
	end
