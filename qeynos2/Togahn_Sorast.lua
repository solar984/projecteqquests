...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 10112, item2 =13165, item3 = 13166, item4 = 13167})) then
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 10113, item2 =13168, item3 = 13169, item4 = 3000})) then
