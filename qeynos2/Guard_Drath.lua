function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Hail, " .. e.other:GetCleanName() .. ".  If you are not busy, we can always use help keeping the beetle population under control in front of the gates.  But be careful, we have had sightings of a large queen beetle out there.");
	elseif(e.message:findi("queen") or e.message:findi("beetle")) then
		e.self:Say("Oh the guards here have nicknamed her Queen Klicnik.  She is big but won't bother you unless she sees you attacking her young.  Then she spits flaming beetle juice all over and young adventurers die.");
