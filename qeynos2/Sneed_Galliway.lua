function event_say(e)
	...
	elseif(e.message:findi("tax")) then
		...
		e.other:SummonItem(13172); -- Item: Galliways Tax Payment
	end
end
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 13717})) then -- rat head
		...
		e.other:Faction(291,25,0); -- Faction: Merchants of Qeynos
		...
		e.other:QuestReward(e.self,{copper = math.random(10), itemid = eq.ChooseRandom(13006,13009,13002,13100), exp = 200}); -- Water Flask, Bandages, Torch, Fishing Pole
	end
