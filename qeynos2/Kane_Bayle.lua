function event_say(e)
	...
	elseif(e.message:findi("donation.* temple.* thunder") or e.message:findi("donate.* temple.* thunder")) then		
		...
		e.other:SummonItem(13293); -- Item: A Donation
	...
	elseif(e.message:findi("going to Highpass")) then
		...
		e.other:SummonItem(13130); -- Item: Blackburrow Stout
	end
end
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 18808})) then
		...
		e.other:Faction(273,100,0); -- Faction: Kane Bayle
		e.other:Faction(230,50,0); -- Faction: Corrupt Qeynos Guards
		e.other:Faction(262,-15,0); -- Faction: Guards of Qeynos
		e.other:Faction(219,-10,0); -- Faction: Antonius Bayle
		e.other:Faction(221,15,0); -- Faction: Bloodsabers
		e.other:QuestReward(e.self,{silver = 3, gold = 3, exp = 500});
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 18809})) then
		...
		e.other:Faction(273,100); -- Faction: Kane Bayle
		e.other:Faction(230,50); -- Faction: Corrupt Qeynos Guards
		e.other:Faction(262,-15); -- Faction: Guards of Qeynos
		e.other:Faction(219,-10); -- Faction: Antonius Bayle
