...
function event_trade(e)
	...
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= -500 and item_lib.check_turn_in(e.self, e.trade, {item1 = 18802}, 0)) then -- A Sealed Letter (Letter to Opal)
		...
		e.other:QuestReward(e.self,{itemid = 14007, exp = 100}); -- Potion of Light Healing
	end
