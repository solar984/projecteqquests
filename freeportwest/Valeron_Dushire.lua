-- items: 51121, 51122, 18737, 13554, 6701, 18827, 13947
...
function event_trade(e)
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 6701})) then --a dusty old leg bone
		...
		e.other:Ding();
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 18827})) then --a testimony of truth
