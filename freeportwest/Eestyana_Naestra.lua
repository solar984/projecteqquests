-- items: 51121, 51122, 18822, 9985, 18804, 6016, 13296, 18735, 13554
...
function event_trade(e)
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 18804})) then
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 18735})) then -- Tattered Note
		...
		e.other:Faction(271,-15,0); -- dismal rage
		e.other:Faction(330,-15,0); -- freeport militia
		e.other:Faction(362,20,0); -- priest of marr
