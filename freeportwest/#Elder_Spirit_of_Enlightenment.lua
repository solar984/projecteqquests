...
function event_say(e)
	...
	if(e.other:Class() == "Shaman") then
		...
		elseif(e.message:findi("wasichu") and qglobals["shaman_epic"] == "2") then
			e.self:Say("The wasichu are those that turn their backs on serving the spirit world for its own sake. They hunger for their own power. At greater risk now are the spirits of Wisdom and Patience. They have become weakened and their fading is eroding what you as shaman often rely upon. The Spirit of Might has lost its way altogether and has crossed over into the darkness of Discord in that other realm. It has been moving amongst the [" .. eq.say_link("dark creatures") .. "] there, using its influence to guide and move some beasts in strange ways.");
		elseif(e.message:findi("dark creatures") and qglobals["shaman_epic"] == "2") then
			e.self:Say("We must prepare a [" .. eq.say_link("ritual") .. "] that has not been performed in many, many years. We hope this one ritual will return the strength of the failing spirits and restore the honor and humility of the Spirit of Might, but there is much preparation to be done. If you are prepared to take on this task, I will tell you what I know. This is no small endeavor, friend. Your mind and body and your strength of spirit will be put to the test.");
		elseif(e.message:findi("ritual") and qglobals["shaman_epic"] == "2") then	
			e.self:Say("The ritual we need to perform is an ancient one, called Ruchu, and it will require a lot of preparation and planning on our parts. To begin with, we need to call upon our allies for help. One thing we need is spirit talismans. In times past, the spirits bestowed very powerful talismans upon a few, but [" .. eq.say_link("great heyokah") .. "]. We are going to need some of them to perform this ritual as they contain some of the essence of the very beings we are tying to save.");
		elseif(e.message:findi("great heyokah") and qglobals["shaman_epic"] == "2") then
			e.self:Say("One of them was a [" .. eq.say_link("wise") .. "] shaman who once walked the lands and gathered every morsel of wisdom his mind could consume in the ways of alchemy and magic. Even though he was a froglok, he was incredibly gifted. His name was Juktopp Gantroc. Though he was small in stature, his knowledge seemed an endless expanse.");
		...
		elseif(e.message:findi("rare gift") and qglobals["shaman_epic"] == "2") then
			e.self:Say("The Spirit of Wisdom itself blessed a talisman and gave it to Juktopp, telling him of our offer. Needless to say, he was overwhelmed and overjoyed. To this day, he remains light as air and just as free in a planar realm of great beauty. You must find him and retrieve the talisman. Give him this potion which will sustain him while we prepare for Ruchu. There is [" .. eq.say_link("still more") .. "] you must do.");
			e.other:SummonItem(57081); --Potion of Sustenance
		elseif(e.message:findi("still more") and qglobals["shaman_epic"] == "2") then
			e.self:Say("When the gods were still young and the ethereal planes were not much more than imagination, the Tribunal wished to create an infallible system of justice. They also wanted those who approached them to hear or plead their case to have their resolve tested so the Tribunal's time would not be wasted. Thus, the Tribunal chose to create [" .. eq.say_link("trials of justice") .. "] so that Norrathians would be required to prove their worth to have their case heard.");
		elseif(e.message:findi("trials of justice") and qglobals["shaman_epic"] == "2") then
			e.self:Say("But it was not that simple. It did take some time to decide how the trials would be created so that they were fair and just and would provide a good test of strength and might. There was a high shaman of Halas who followed the path lain by the Tribunal and lived his life according to law and justice. His name was [" .. eq.say_link("Veshtaq") .. "] MacDunahon.");
		elseif(e.message:findi("veshtaq") and qglobals["shaman_epic"] == "2") then
			e.self:Say("Veshtaq's strict adherence to justice eventually earned the attention of the Tribunal and he was asked to ascend from the mortal realm to aid them in creating trials that would be suitable to place before Norrathians wishing to approach the greatness of the Tribunal. Of course, Veshtaq obliged and [" .. eq.say_link("succeeded") .. "] in creating a series of trials that allowed Norrathians to prove their worth.");
		elseif(e.message:findi("succeeded") and qglobals["shaman_epic"] == "2") then
			e.self:Say("When his work was done, Veshtaq suddenly realized that he had grown much older and his time in the land had weakened his ties with the natural spirits of the world. This [" .. eq.say_link("troubled") .. "] him greatly. He felt his life perhaps had come to no real meaning.");
		...
		elseif(e.message:findi("meaningful way") and qglobals["shaman_epic"] == "2") then
			e.self:Say("For a shaman, a blessing of eternal life from any spirit is an honor, so a talisman was created by the Spirit of Patience to sustain Veshtaq for all time and he would be once again be rejoined with the spirit world. Now, " .. e.other:GetName() .. ", it is up to you to retrieve the talisman. You may not simply ask for it. You will have to complete the very trial he commands and defeat his essence. Do not fret. The Tribunal will sustain him in that plane so he may continue his work.");
...
function event_timer(e)
	...
	elseif e.timer=="event" then
		...
		elseif(count == 13) then	
			client:Message(MT.White,"The Spirit of Might appears and disappears, unable to keep a hold in this realm. You hear: 'It has its grip on me. You must let me go.'");
