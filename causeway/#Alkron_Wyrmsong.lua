...
function event_trade(e)
    ...
    if qglobals["bard15"] == "6" then
        if item_lib.check_turn_in(e.self, e.trade, {item1 = 77641, item2 = 77642, item3 = 77643, item4 = 47100}) then -- black chaos and globe
    ...
    if qglobals["bard20"] == "1" then
        if item_lib.check_turn_in(e.self, e.trade, {item1 = 77644, item2 = 77613, item3 = 77631}) then -- Dragorn Essence, Dark Orb, Prismatic Dragon Blade
