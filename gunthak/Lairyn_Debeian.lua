...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 58009}) ) then --pouch of dark ice
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 52354}) ) then --cloudy potion
		e.self:SetHP(e.self:GetHP()+3000);
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 52344}) ) then --krill head
