...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 20876})) then
		...
		e.other:Faction(246,5,0); -- faydarks champion
		e.other:Faction(279,1,0); -- king tearis thex
		e.other:Faction(226,1,0); -- cleric of tunare
		e.other:Faction(310,1,0); -- soldier of tunare
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 20881,item2 = 20880,item3 = 10151,item4 = 5408})) then
		...
		e.other:Faction(246,100,0); -- faydarks champion
		e.other:Faction(279,25,0); -- king tearis thex
		e.other:Faction(226,25,0); -- cleric of tunare
		e.other:Faction(310,25,0); -- soldier of tunare
		e.other:Faction(234,-25,0); -- crushbone orcs
