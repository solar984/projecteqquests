...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 2053})) then -- Dragon Craft Urn (2nd combined version)
	...
	elseif(e.other:GetFaction(e.self) < 2 and item_lib.check_turn_in(e.self, e.trade, {item1 = 1728})) then -- Ethereal Bladed Naginata
	...
	elseif(e.other:GetFaction(e.self) < 2 and item_lib.check_turn_in(e.self, e.trade, {item1 = 2097})) then -- Ethereal Bladed Naginata (Eldriak's Verified Naginata)
	...
	elseif(e.other:GetFaction(e.self) < 2 and item_lib.check_turn_in(e.self, e.trade, {item1 = 2065})) then -- Sanctum Guardian's Earring
	...
	elseif(e.other:GetFaction(e.self) < 2 and item_lib.check_turn_in(e.self, e.trade, {item1 = 2064})) then -- Pitted Iron Ring
