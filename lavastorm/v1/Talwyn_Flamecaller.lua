...
function event_trade(e)
  ...
  if (item_lib.check_turn_in(e.self, e.trade, {item1 = 11445, item2 = 11448, item3 = 11474, item4 = 11576})) then -- Item: Fluxing Staff
  ...
  elseif (item_lib.check_turn_in(e.self, e.trade, {item1 = 11619})) then -- Item: Wisp of Pure Flame
  ...
  elseif (item_lib.check_turn_in(e.self, e.trade, {item1 = 11599})) then -- Item: Shard of Pure Ice
  ...
  elseif (item_lib.check_turn_in(e.self, e.trade, {item1 = 12596})) then -- Item: Silken Tapestry Satchel
  ...
  elseif (item_lib.check_turn_in(e.self, e.trade, {item1 = 16753})) then -- Item: Full Tapestry Satchel
  ...
  elseif (qglobals["wiz_epic20"] ~= nil and qglobals["wiz_epic20"] >= "3" and item_lib.check_turn_in(e.self, e.trade, {item1 = 47100})) then -- Item: Globe of Discordant Energy
  ...
  elseif (qglobals["wiz_epic20"] == "4" and item_lib.check_turn_in(e.self, e.trade, {item1 = 16451, item2 = 16334, item3 = 12665})) then
  ...
  elseif (qglobals["wiz_test_intel"] ~= nil) then -- 10 items for Test of Intelligence in order
    if (qglobals["wiz_test_intel"] == "1" and item_lib.check_turn_in(e.self, e.trade, {item1 = 11425})) then -- Item: Empty Jug
    ...
    elseif (qglobals["wiz_test_intel"] == "2" and item_lib.check_turn_in(e.self, e.trade, {item1 = 11419})) then -- Item: Emerald-Tipped Staff
      e.self:Say("Excellent, you are impressing me more and more with each passing day. This note will begin the next riddle that you will need to solve. Return to me with the correct answer to continue your journey. Again, I remind you, take care when handling these notes, they are the lifeblood that will guide you on your journey and should you lose them, you will fail the test. I hope to see you back here with the correct answer soon.");
      e.other:SummonItem(11044); -- Item: Old Parchment
      eq.set_global("wiz_test_intel","3",5,"F");
    elseif (qglobals["wiz_test_intel"] == "3" and item_lib.check_turn_in(e.self, e.trade, {item1 = 11282})) then -- Item: Meditation Basket
      e.self:Say("Excellent, you are impressing me more and more with each passing day. This note will begin the next riddle that you will need to solve. Return to me with the correct answer to continue your journey. Again, I remind you, take care when handling these notes, they are the lifeblood that will guide you on your journey and should you lose them, you will fail the test. I hope to see you back here with the correct answer soon.");
      e.other:SummonItem(11200); -- Item: Old Parchment
      eq.set_global("wiz_test_intel","4",5,"F");
    elseif (qglobals["wiz_test_intel"] == "4" and item_lib.check_turn_in(e.self, e.trade, {item1 = 11433})) then -- Item: Platinum Token
      e.self:Say("Excellent, you are impressing me more and more with each passing day. This note will begin the next riddle that you will need to solve. Return to me with the correct answer to continue your journey. Again, I remind you, take care when handling these notes, they are the lifeblood that will guide you on your journey and should you lose them, you will fail the test. I hope to see you back here with the correct answer soon.");
      e.other:SummonItem(11148); -- Item: Old Parchment
      eq.set_global("wiz_test_intel","5",5,"F");
    elseif (qglobals["wiz_test_intel"] == "5" and item_lib.check_turn_in(e.self, e.trade, {item1 = 11413})) then -- Item: White Sash
      e.self:Say("Excellent, you are impressing me more and more with each passing day. This note will begin the next riddle that you will need to solve. Return to me with the correct answer to continue your journey. Again, I remind you, take care when handling these notes, they are the lifeblood that will guide you on your journey and should you lose them, you will fail the test. I hope to see you back here with the correct answer soon.");
      e.other:SummonItem(11194); -- Item: Old Parchment
      eq.set_global("wiz_test_intel","6",5,"F");
    elseif (qglobals["wiz_test_intel"] == "6" and item_lib.check_turn_in(e.self, e.trade, {item1 = 11424})) then -- Item: Golden Dagger
      e.self:Say("Excellent, you are impressing me more and more with each passing day. This note will begin the next riddle that you will need to solve. Return to me with the correct answer to continue your journey. Again, I remind you, take care when handling these notes, they are the lifeblood that will guide you on your journey and should you lose them, you will fail the test. I hope to see you back here with the correct answer soon.");
      e.other:SummonItem(11279); -- Item: Old Parchment
      eq.set_global("wiz_test_intel","7",5,"F");
    elseif (qglobals["wiz_test_intel"] == "7" and item_lib.check_turn_in(e.self, e.trade, {item1 = 11436})) then -- Item: Ivory Bone
      e.self:Say("Excellent, you are impressing me more and more with each passing day. This note will begin the next riddle that you will need to solve. Return to me with the correct answer to continue your journey. Again, I remind you, take care when handling these notes, they are the lifeblood that will guide you on your journey and should you lose them, you will fail the test. I hope to see you back here with the correct answer soon.");
      e.other:SummonItem(11166); -- Item: Old Parchment
      eq.set_global("wiz_test_intel","8",5,"F");
    elseif (qglobals["wiz_test_intel"] == "8" and item_lib.check_turn_in(e.self, e.trade, {item1 = 11418})) then -- Item: Red Cloth
      e.self:Say("Excellent, you are impressing me more and more with each passing day. This note will begin the next riddle that you will need to solve. Return to me with the correct answer to continue your journey. Again, I remind you, take care when handling these notes, they are the lifeblood that will guide you on your journey and should you lose them, you will fail the test. I hope to see you back here with the correct answer soon.");
      e.other:SummonItem(11095); -- Item: Old Parchment
      eq.set_global("wiz_test_intel","9",5,"F");
    elseif (qglobals["wiz_test_intel"] == "9" and item_lib.check_turn_in(e.self, e.trade, {item1 = 11299})) then -- Item: Worn Turban
      e.self:Say("Excellent, you are impressing me more and more with each passing day. This note will begin the next riddle that you will need to solve. Return to me with the correct answer to continue your journey. Again, I remind you, take care when handling these notes, they are the lifeblood that will guide you on your journey and should you lose them, you will fail the test. I hope to see you back here with the correct answer soon.");
      e.other:SummonItem(11102); -- Item: Old Parchment
      eq.set_global("wiz_test_intel","10",5,"F");
    elseif (qglobals["wiz_test_intel"] == "10" and item_lib.check_turn_in(e.self, e.trade, {item1 = 11412})) then -- Item: Old Pipe
  ...
  elseif (qglobals["wiz_epic_pre"] == "2" and item_lib.check_turn_in(e.self, e.trade, {item1 = 16675})) then -- Item: Cursed Talisman
  ...
  elseif ((qglobals["wiz_epic_pre"] == "3" or qglobals["wiz_epic_pre"] == "4") and item_lib.check_turn_in(e.self, e.trade, {item1 = 16623})) then -- Item: Spell: Electrical Charge
