...
function event_trade(e)
	...
	local qglobals = eq.get_qglobals(e.other);
	if(qglobals["warrior_epic"] ~= nil and qglobals["warrior_epic"] >= "3" and item_lib.check_turn_in(e.self, e.trade, {item1 = 60305})) then --Sealed Vial of Blackfall Blood (from korbuk)
