...
function event_enter(e)
	if(e.other:HasItem(18743)) then
		e.other:Message(MT.Yellow,"You find yourself in a small, dimly lit room. A dark figure steps from the shadows and greets you. 'Welcome young apprentice. I am Pietro Zarn your new Guild Master. I am glad you found us. Read the note in your inventory and hand it to me when you wish to begin your training.'");
	end
end
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 18743})) then -- A tattered note
		...
		e.other:AddEXP(100);
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 18961})) then -- Translated Parchment
