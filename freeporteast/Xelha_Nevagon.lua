...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 13099, item2 = 13099, item3 = 13099, item4 = 13099})) then -- Spiderling Silk
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 10307, item2 = 10307, item3 = 10307, item4 = 10307})) then -- Fire Beetle Eye
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13073, item2 = 13073, item3 = 13073, item4 = 13073})) then -- Bone Chips
		...
		e.other:AddEXP(20);
		e.other:GiveCash(0,4,0,0);
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13927})) then -- Cyclops Eye
