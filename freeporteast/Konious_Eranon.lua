...
function event_enter(e)
	if e.other:HasItem(18856) then
		e.other:Message(MT.Yellow,"You find yourself in a small, dimly lit room. A dark figure steps from the shadows and greets you. 'Welcome young apprentice. I am Konious Eranon your new Guild Master. I am glad you found us. Read the note in your inventory and hand it to me when you wish to begin your training.'");
	end
end
