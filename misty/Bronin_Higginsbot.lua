function event_say(e)
	...
	elseif(e.message:findi("small favor")) then
		if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 15) then
	...
	elseif(e.message:findi("second piece of.* gem")) then
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 13110})) then -- Bloody Shank
		...
		e.other:Faction(241, -50); -- Deeppockets
		e.other:Faction(223, -2); -- Circle Of Unseen Hands
		e.other:Faction(292, 2); -- Merchants of Rivervale
	...
	elseif((e.other:GetFaction(e.self) < 5) and (item_lib.check_turn_in(e.self, e.trade, {item1 = 12192}))) then -- Froglok Leg
		...
		e.other:Faction(241, 10);   -- Deeppockets
