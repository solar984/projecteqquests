...
function event_say(e)
	...
	elseif(e.message:findi("collection")) then
		if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= -100) then
			...
			e.other:SummonItem(17922); -- Item: Bug Collection Box
		else
	...
	elseif(e.message:findi("list")) then
		if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= -100) then
			...
			e.other:SummonItem(18011); -- Item: Want List
		else
			e.self:Say(eq.ChooseRandom("I didn't know Slime could speak common. Go back to the sewer before I lose my temper.","Is that your BREATH, or did something die in here? Now go away!","I wonder how much I could get for the tongue of a blithering fool? Leave before I decide to find out for myself."));
		end
	end
...
function event_trade(e)
	...
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= -100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13268, item2 = 18011},1,text)) then
