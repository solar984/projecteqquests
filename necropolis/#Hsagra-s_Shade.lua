...
function event_trade(e)
    ...
    if qglobals["bard15"] == "2" then
        ...
        if item_lib.check_turn_in(e.self, e.trade, {item1 = 77608, item2 = 77609, item3 = 77610, item4 = 77611}) then
            ...
            eq.zone_emote(MT.Yellow, "You hear a dark cackle slither through your ears and your eyes drift across the lingering trail of drifting black ooze back towards the opening of the cavern.")
