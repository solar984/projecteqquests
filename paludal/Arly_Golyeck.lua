...
function event_trade(e)
	...
	if(qglobals["Fatestealer"] == "1" and item_lib.check_turn_in(e.self, e.trade, {item1 = 9810 })) then
	...
	elseif(qglobals["Fatestealer"] == "1" and qglobals["Fatestealer_gem"] == nil and item_lib.check_turn_in(e.self, e.trade, {item1 = 52353})) then 
