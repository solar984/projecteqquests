...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 12204})) then
		...
		e.other:Faction(291,20); -- Faction: Merchants of Qeynos
		e.other:Faction(223,-4); -- Faction: Circle of Unseen Hands
		e.other:Faction(219,3); -- Faction: Antonius Bayle
		e.other:Faction(229,2); -- Faction: Coalition of Tradefolk
		e.other:Faction(262,4); -- Faction: Guards of Qeynos
		e.other:QuestReward(e.self,{itemid = 5416, exp = 500}); -- Item: Gnoll Slayer
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 8357,item2 = 8356,item3 = 5416})) then
		...
		e.other:Faction(291,200); -- Faction: Merchants of Qeynos
		e.other:Faction(223,-40); -- Faction: Circle of Unseen Hands
		e.other:Faction(219,30); -- Faction: Antonius Bayle
		e.other:Faction(229,20); -- Faction: Coalition of Tradefolk
		e.other:Faction(262,40); -- Faction: Guards of Qeynos
		e.other:QuestReward(e.self,{itemid = 5417, exp = 1500}); -- Item: Gnoll Slayer
	end
