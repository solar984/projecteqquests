...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 13752, gold = 21})) then
		...
		e.other:AddEXP(500);
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13751, gold = 15})) then
		e.self:Say("Oh.. I see.. But um.. I still need the other thing before I can make anything for you.. sorry.");
		...
		e.other:Faction(280,1,0); -- Priests of Life
		e.other:AddEXP(500);
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13750, gold = 5})) then
		e.self:Say("Oh.. I see.. But um.. I still need the other thing before I can make anything for you.. sorry.");
