...
function event_say(e)
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) > -83) then
...
function event_trade(e)
	...
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) > -83 and item_lib.check_turn_in(e.self, e.trade, {item1 = 14373},0)) then
		e.self:Say("Kyrenna! We are free!");
		eq.spawn2(39106, 0, 0, -195.8, 426.6, -213.9, 115):AddToHateList(e.other,1);
