function event_trade(e)
	...
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 700 and item_lib.check_turn_in(e.self, e.trade, {item1 = 1671})) then --Part of Shaman Epic 1.0
		...
		eq.spawn2(39073,0,0,e.self:GetX(),e.self:GetY(),e.self:GetZ(),e.self:GetHeading()):AddToHateList(e.other,1); -- NPC: #High_Scale_Kirn
		eq.depop_with_timer();
	end
