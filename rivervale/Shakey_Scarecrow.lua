...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 14321})) then
		...
		e.other:Faction(355,25); -- +Storm Reapers
		e.other:Faction(286,2); -- +Mayor Gubbin
		e.other:Faction(292,3); -- +Merchants of Rivervale
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 11139})) then
		...
		e.other:QuestReward(e.self,{items = {52355,52355}, exp = 500}) -- Dilapidated Head of Shakey
