...
function event_say(e)
	...
	elseif(eq.is_the_shadows_of_luclin_enabled()) then
		...
		elseif(e.message:findi("bracers")) then
			...
			e.other:SummonItem(22672); -- Item: An Enchanted Bracer Pattern
		elseif(e.message:findi("sleeves")) then
			...
			e.other:SummonItem(22673); -- Item: An Enchanted Sleeves Pattern
		elseif(e.message:findi("boots")) then
			...
			e.other:SummonItem(22674); -- Item: An Enchanted Boots Pattern
		elseif(e.message:findi("legplates")) then
			...
			e.other:SummonItem(22675); -- Item: An Enchanted Legplates Pattern
		elseif(e.message:findi("gauntlets")) then
			...
			e.other:SummonItem(22676); -- Item: An Enchanted Gauntlets Pattern
		elseif(e.message:findi("tunic")) then
			...
			e.other:SummonItem(22677); -- Item: An Enchanted Tunic Pattern
...
function event_trade(e)
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 22693,item2 = 22694})) then -- missing quest reward dialogue?
		e.other:Faction(241,10,0); -- Deeppockets
