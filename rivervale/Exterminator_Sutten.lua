...
local item_lib = require("items");
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 13071, item2 = 13071, item3 = 13071, item4 = 13071})) then --End of Exterminate the Vermin (Scripted By: Fatty Beerbelly)
