function event_say(e)
	...
	elseif(e.message:findi("deputy tagil")) then
		if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 100) then -- requires amiably
			...
			e.other:SummonItem(18013); -- Item: A Note 
...
function event_trade(e)
	...
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13240})) then
