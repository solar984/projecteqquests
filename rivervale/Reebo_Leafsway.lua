...
function event_trade(e)
	...
	elseif(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 0 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13974,item2 = 13974,item3 = 13974,item4 = 13974},1,text)) then
		...
		e.other:Faction(355,10); -- +Storm Reapers
