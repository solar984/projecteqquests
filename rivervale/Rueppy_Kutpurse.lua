function event_say(e)
	...
	elseif(e.message:findi("smuggle")) then
		if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 300) then -- requires high amiably
...
function event_trade(e)
	...
	elseif(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 300 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13131})) then -- Case of Blackburrow Stout
