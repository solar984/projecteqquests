...
function event_trade(e)
	...
	if (e.self:GetNPCTypeID() == 52056 and item_lib.check_turn_in(e.self, e.trade, {item1 = 12211})) then -- Mittens
		...
		eq.depop();
	elseif (e.self:GetNPCTypeID() == 52118 and item_lib.check_turn_in(e.self, e.trade, {item1 = 12217})) then -- butcher arpron
		...
		eq.depop();
	elseif (e.self:GetNPCTypeID() == 52119 and item_lib.check_turn_in(e.self, e.trade, {item1 = 12198, item2 = 12198, item3 = 12198, item4 = 12198})) then -- fifes
