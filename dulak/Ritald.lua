...
function event_trade(e)
	...
	if qglobals["shadowknight_pre"] == "1" and item_lib.check_turn_in(e.self, e.trade, {item1 = 55902, item2 = 21870, item3 = 21782}) then --hand in Ancient Flamberge of Hatred (drops from Captain Varns in dulaks), Essence of Hate (Drops from nameds in PoHate), and Stormborn Phylactery (drops from Olidan in PoStorms)
