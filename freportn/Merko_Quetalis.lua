...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 14018})) then -- A spider venom sac
		...
		e.other:AddEXP(100);
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 12144, item2 = 13865})) then -- Token of Bravery  / Token of Generosity
		...
		e.other:Faction(311,1,0); -- Steel Warriors
		e.other:AddEXP(100);
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13866})) then -- Token of Truth
