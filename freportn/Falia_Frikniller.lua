...
function event_trade(e)
	...
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= -500 and item_lib.check_turn_in(e.self, e.trade, {item1 = 18925})) then
		...
		e.other:QuestReward(e.self,{itemid = 13159, exp = 500}); -- Item: Broken Heirloom Necklace
	end
