...
function event_trade(e)
	...
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 0 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13921})) then
	...
	elseif(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 12142})) then
		...
		if (eq.is_content_flag_enabled("May1999")) then
			e.other:QuestReward(e.self,{itemid = eq.ChooseRandom(15560,15230,15219,15229,15222,15012), exp = 5000}); -- Item(s): Spell: Furor (15560), Spell: Root (15230), Spell: Center (15219), Spell: Fear (15229), Spell: Invigor (15222), Spell: Healing (15012)
		else
			e.other:QuestReward(e.self,{itemid = eq.ChooseRandom(15230,15219,15229,15222,15012), exp = 5000}); -- Item(s): Spell: Root (15230), Spell: Center (15219), Spell: Fear (15229), Spell: Invigor (15222), Spell: Healing (15012)
		end
	end
