...
function event_say(e)
	...
	elseif(e.message:findi("i follow fear")) then -- Part of Shaman Epic 1.0
		e.self:Say("You would be best served by speaking to my brother in the next room, " .. e.other:GetCleanName() .. ".");
		eq.unique_spawn(8118,0,0,67,103,32.1,508); -- NPC: a_greater_spirit_
	...
	elseif(e.message:findi("heyokah")) then -- Part of Shaman Epic 1.0
		...
		e.other:QuestReward(e.self,{itemid = 1666});
