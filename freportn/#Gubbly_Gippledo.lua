...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 55030,item2 = 55029})) then
		...
		e.other:Faction(1719,5); -- Faction: Citizens of Gukta
		e.other:Faction(1709,5); -- Faction: Protectors of Gukta
		e.other:Faction(1716,5); -- Faction: High Council of Gukta
		e.other:Faction(1717,5); -- Faction: Lorekeepers of Gukta
		e.other:Faction(1718,5); -- Faction: Guktan Elders
		e.other:QuestReward(e.self,{exp = 4000, items = {55031,55032}});-- Item: Note to Bibsy, Item: Marr's Ring
	end
