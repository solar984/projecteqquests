...
function event_trade(e)
	...
	if (item_lib.check_turn_in(e.self, e.trade, {item1 = 67519})) then	-- Tuned Farstone
	...
	elseif (item_lib.check_turn_in(e.self, e.trade, {item1 = 67521,item2 = 67522,item3 = 67523,item4 = 67524})) then 
