...
function event_trade(e)
	...
	if(qglobals["shaman_epic"] == "1" and item_lib.check_turn_in(e.self, e.trade, {item1 = 57550, item2 = 57369})) then -- hand in Shadowed Pulp and Brittle Twigs (both are result of combines of quest items gathered up to this point, recipes probably need to be added to db)
