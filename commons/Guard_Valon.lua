...
function event_say(e)
	...
	elseif(e.message:findi("hunt dervish cutthroats")) then
		if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 100) then
			...
			e.other:SummonItem(17975); -- Item: Bag for Cutthroat Rings
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 13885,item2 = 13885,item3 = 13885,item4 = 13885},1,text)) then
		...
		e.other:Faction(362,-1); -- priests of marr
		e.other:QuestReward(e.self,0,0,math.random(5),0,0,500);
	elseif(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 12272})) then
		...
		e.other:Faction(330,10); -- freeport militia
		e.other:Faction(336,1); -- coalition of tradefolk underground
		e.other:Faction(281,-1); -- knights of truth
		e.other:Faction(362,-1); -- priests of marr
