function event_say(e)
    ...
    elseif(e.message:findi("bantil sent me") and qglobals["mage_epic"] == "5") then
        e.self:Say("You are working with Bantil? I hope you had some luck finding the books. Let me know if there is anything I can do to help you. Bantil is a friend, despite his gnomish heritage.");
        eq.set_global("mage_epic_jah","1",5,"F");
        if(qglobals["mage_epic_wal"] ~= nil) then
        	e.sef:Say("Oh, you may want to speak to Akksstaff again, he and Bantil never quite saw eye to eye, you may want to ask him about Bantil again.");
        end
	end
end
