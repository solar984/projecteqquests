...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 28014})) then -- Stanos' Pouch
		...
		e.other:AddEXP(1500);
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 5411,item2 = 5410,item3 = 5401,item4 = 5308})) then -- Fleshripper, Painbringer, Mithril Two-Handed Sword, Gigantic Zweihander
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 1357,item2 = 1253,item3 = 1354,item4 = 1360})) then -- Robe of the Ishva, Robe of the Kedge, Robe of the Oracle, Shining Mettalic Robes
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 7041,item2 = 7509,item3 = 7508,item4 = 7020})) then -- Burning Rapier, Martune Rapier, Eyerazzia, Well-Balanced Rapier
