...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 13954})) then -- Prime Healer Potion (Good)
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13955})) then	-- Prime Healer Potion (Bad)
