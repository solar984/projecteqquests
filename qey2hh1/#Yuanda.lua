...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 15809})) then -- Note to Yuanda
		...
		e.other:Ding();
		eq.spawn2(12020, 0, 0, xloc -18, yloc -35, zloc,   256); -- a snarling werewolf (normal)
		eq.spawn2(12020, 0, 0, xloc +18, yloc -35, zloc,   256); -- a snarling werewolf (normal)
		eq.spawn2(12020, 0, 0, xloc -35, yloc +10, zloc+5, 256); -- a snarling werewolf (normal)
		eq.spawn2(12020, 0, 0, xloc +35, yloc +10, zloc,   256); -- a snarling werewolf (normal)
		eq.spawn2(12021, 0, 0, xloc,    yloc +35, zloc,   256); -- a snarling werewolf (high)
		eq.depop_with_timer();
	end
