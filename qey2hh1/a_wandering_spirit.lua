function event_say(e)
	if(e.message:findi("hail")) then
		...
		eq.pause(30);
	elseif(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 300) then
...
function event_trade(e)
	...
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 1667})) then -- Part of Shaman Epic 1.0
		...
		e.other:Faction(404,100,0); -- Faction: True Spirit
		e.other:QuestReward(e.self,0,0,0,0,0,1000);
	elseif(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 200 and item_lib.check_turn_in(e.self, e.trade, {item1 = 1675,item2 = 1676,item3 = 1677},1,text)) then -- Part of Shaman Epic 1.0
