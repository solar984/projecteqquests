...
function event_trade(e)
	...
	if(qglobals["berserk_epic"] ~= nil and qglobals["berserk_epic"] >= "1" and item_lib.check_turn_in(e.self, e.trade, {item1 = 15793, item2 = 17589, item3 = 17319, item4 = 17496})) then
	...
	if(qglobals["berserk_epic"] ~= nil and qglobals["berserk_epic"] >= "2" and item_lib.check_turn_in(e.self, e.trade, {item1 = 17286, item2 = 17286, item3 = 17286, item4 = 17286})) then
