...
function event_trade(e)
	...
	if(qglobals["Halloween2018"] == "1" and item_lib.check_turn_in(e.self, e.trade, {item1 = 46200})) then -- Halloween 2018
	...
	elseif (item_lib.check_turn_in(e.self, e.trade, {item1 = 84017})) then
	...
	elseif (qglobals["Halloween2018EXP"] == "1" and item_lib.check_turn_in(e.self, e.trade, {item1 = 19004})) then
