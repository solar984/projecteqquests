...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 54239}) and e.other:HasItem(52952) and not eq.get_entity_list():IsMobSpawnedByNpcTypeID(119184)) then
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 52949}) and e.other:HasItem(52952)) then
