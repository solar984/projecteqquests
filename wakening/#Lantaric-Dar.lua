...
function event_trade(e)
    ...
    local qglobals = eq.get_qglobals(e.other)
    if qglobals["bard15"] == "1" and item_lib.check_turn_in(e.self, e.trade, {item1 = 77608}) then -- Cracked Dragon Bone
    ...
    elseif qglobals["bard15"] == "2" and item_lib.check_turn_in(e.self, e.trade, {item1 = 77612}) then -- Blackened Dragon Bone
    ...
    elseif qglobals["bard15"] == "3" and item_lib.check_turn_in(e.self, e.trade, {item1 = 77613}) then -- Dark Orb
    ...
    elseif item_lib.check_turn_in(e.self, e.trade, {item1 = 77600,item2 =77600, item3 = 77600}) then -- Storm Giant Herald Head 3x
    ...
    elseif qglobals["bardPQ"] == "1" and  item_lib.check_turn_in(e.self, e.trade, {item1 = 77601}) then -- Kromzek Supply Orders
	...
	elseif qglobals["bardPQ"] == "2" and  item_lib.check_turn_in(e.self, e.trade, {item1 = 77602}) then -- Sealed Note
	...
	elseif qglobals["bardPQ"] == "4" and item_lib.check_turn_in(e.self, e.trade, {item1 = 77604,item2 =77605, item3 = 77606, item4 = 77607}) then
        eq.set_global("bard15", "1", 5, "F")
