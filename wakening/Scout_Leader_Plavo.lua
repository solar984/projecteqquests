...
function event_trade(e)
	...
	local qglobals = eq.get_qglobals(e.other);
	if qglobals["cleric_epic"] ~= nil and qglobals["cleric_epic"] >= "4" and item_lib.check_turn_in(e.self, e.trade, {item1 = 9591}) then  --Dark Disciples Notice of Service
	...
	elseif qglobals["cleric_epic"] ~= nil and qglobals["cleric_epic"] >= "5" and item_lib.check_turn_in(e.self, e.trade, {item1 = 9945, item2 = 9948, item3 = 9597}) then -- Shissar Cerebral Cortex // Dragon Cerebrum // Akhevan Brain Stem
