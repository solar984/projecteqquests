...
function event_trade(e)
	...
	if(e.other:GetFaction(e.self) < 6 and item_lib.check_turn_in(e.self, e.trade, {item1 = 30989})) then
	...
	elseif(e.other:GetFaction(e.self) < 6 and item_lib.check_turn_in(e.self, e.trade, {item1 = 30991, item2 = 30990, item3 = 30993, item4 = 30992})) then
