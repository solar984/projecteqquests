...
function event_trade(e)
	...
	elseif qglobals["wizepicK"] ~= nil then
		if item_lib.check_turn_in(e.self, e.trade, {item1 = 14349}) then
			...
			e.other:QuestReward(e.self,{itemid = 14339});  -- Item: Staff of Gabstik
			e.other:SummonItem(18168); -- Item: note
		...
		elseif item_lib.check_turn_in(e.self, e.trade, {item1 = 14333, item2 = 14332}) then
			e.other:QuestReward(e.self,{itemid = 14339});  -- Item: Staff of Gabstik
			e.other:SummonItem(14336); -- Item: note
		...
		elseif item_lib.check_turn_in(e.self, e.trade, {item1 = 14332, item2 = 14332}) then
			...
			e.other:QuestReward(e.self,{itemid = 14332});  -- Item: Cazic's Skin
