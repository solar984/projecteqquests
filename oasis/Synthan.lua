...
function event_trade(e)
	...
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 0 and (ls > 0)) then -- Lightstone turn in, reward is either Runes and Research Volume I or II
		repeat
	...
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 0 and (gls > 0)) then -- Greater Lightstone
		repeat
