...
function event_trade(e)
	...
	local qglobals = eq.get_qglobals(e.other);
	if(qglobals["warrior_epic"] == "14" and item_lib.check_turn_in(e.self, e.trade, {item1 = 60320, item2 = 60306, item3 = 60303})) then --Blackfall Blade, Potion of Blackfall Spirit and Hilt of Eternal Power
