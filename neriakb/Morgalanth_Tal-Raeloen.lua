function event_say(e)
	...
	elseif(e.message:findi("understand")) then
		if((e.other:GetClass() == 12 or e.other:GetClass() == 13 or e.other:GetClass() == 14) and e.other:GetRace() == 6) then
			...
			e.other:SummonItem(17246);--Mystical Sewing Kit
		else
	...
	elseif(e.message:findi("skullcaps")) then
		...
		e.other:SummonItem(22628);--Enchanted Cap Pattern
	elseif(e.message:findi("bracers")) then
		...
		e.other:SummonItem(22629);--Enchanted Bracer Pattern
	elseif(e.message:findi("sandals")) then
		...
		e.other:SummonItem(22630);--Enchanted Slippers Pattern
	elseif(e.message:findi("sleeves")) then
		...
		e.other:SummonItem(22631);--Enchanted Sleeves Pattern
	elseif(e.message:findi("trousers")) then
		...
		e.other:SummonItem(22632);--Enchanted Trousers Pattern
	elseif(e.message:findi("gloves")) then
		...
		e.other:SummonItem(22633);--Enchanted Gloves Pattern
	elseif(e.message:findi("robes")) then
		...
		e.other:SummonItem(22634);--Enchanted Robe Pattern
