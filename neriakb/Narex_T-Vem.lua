...
function event_trade(e)
	...
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13886})) then --Goblin Supply Pouch
		...
		e.other:Faction(270, 25); --Indigo Brotherhood
		e.other:Faction(326,-3); --Emerald Warriors
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13113, item2 = 13113, item3 = 13113, item4 = 13113},1,text)) then --Leatherfoot Raider Skullcap -- this hand-in doesn't have faction check apparently
		...
		e.other:Faction(270, 50); --Indigo Brotherhood
		e.other:Faction(326,-7); --Emerald Warriors
		e.other:Faction(311,-2); --Steel Warriors
		e.other:Faction(1522,-100); --Primordial Malice
