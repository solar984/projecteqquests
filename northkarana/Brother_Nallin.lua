...
function event_trade(e)
	...
	if(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 0 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13006, item2 = 13006, item3 = 13006, item4 = 13006})) then
	...
	elseif(e.other:GetModCharacterFactionLevel(e.self:GetPrimaryFaction()) >= 0 and item_lib.check_turn_in(e.self, e.trade, {gold = 5}, 0)) then
		e.self:Say("May Rodcet Nife breathe upon your body and soul and banish the evil from within.");
